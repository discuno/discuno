...
3. **Destination charge:** Checkout creates a destination charge for the mentor’s Express account while Discuno retains its configured platform share.
...
- [ ] Confirm payout timing, platform-fee, refund, and cancellation policies before production rollout
