...
export const BookingConfirmationStep = () => {
  return (
    <div className="flex h-full flex-col items-center justify-center px-6 py-12 text-center">
      <div className="bg-primary text-primary-foreground mb-6 flex h-14 w-14 items-center justify-center rounded-full shadow-sm">
        <Check className="h-7 w-7" strokeWidth={2.5} />
      </div>
      <p className="text-primary mb-2 text-xs font-semibold tracking-[0.14em] uppercase">
        Confirmed
      </p>
      <h2 className="text-foreground text-2xl font-semibold tracking-tight">You’re booked</h2>
