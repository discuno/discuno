import { StripeDashboard } from '~/app/(app)/(mentor)/dashboard/components/StripeDashboard'
import { getMentorStripeStatus } from '~/app/(app)/(mentor)/settings/scheduling/actions'
