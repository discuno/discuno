import { BookingContent } from '~/app/(default)/(dashboard)/book/components/BookingContent'
import { BookingShell } from '~/app/(default)/(dashboard)/book/components/BookingShell'
