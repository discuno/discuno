    ...
    <div className="bg-background min-h-screen">
      ...
      <div className="mx-auto max-w-2xl px-4 py-16 sm:px-6 lg:px-8">
        <div className="text-center">
          {/* Error Badge */}
          <Badge
            variant={isOAuthAccountNotLinked ? 'secondary' : 'destructive'}
          ...
          {/* Main Error Card */}
          <Card
            className={`${isOAuthAccountNotLinked ? 'border-secondary/20' : 'border-destructive/20'} bg-card/50 backdrop-blur-sm`}
          >
            <CardHeader>
              <div
                className={`${isOAuthAccountNotLinked ? 'bg-secondary/10' : 'bg-destructive/10'} mx-auto mb-4 flex h-16 w-16 items-center justify-center rounded-full`}
              >
                {isOAuthAccountNotLinked ? (
              ...
              <div className="flex flex-col gap-3 sm:flex-row sm:justify-center">
                <Button asChild variant="default">
                  <Link href="/auth" className="flex items-center gap-2">
                    ...
                    {isOAuthAccountNotLinked ? 'Try Different Sign-In' : 'Try Again'}
                  </Link>
                </Button>
