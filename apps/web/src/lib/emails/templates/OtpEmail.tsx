...
export const OtpEmail = ({ code, host }: Readonly<OtpEmailProps>) => (
  <Html>
    <Head />
    ...
    <Body style={main}>
      <Container style={container}>
        ...
        <Text style={paragraph}>
          Contact{' '}
          <Link href="mailto:support@discuno.com" style={link}>
            support@discuno.com
          </Link>{' '}
          if you did not request this code.
        </Text>
      </Container>
      <Text style={footer}>Securely powered by Discuno.</Text>
    </Body>
  </Html>
)
